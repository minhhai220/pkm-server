...
local function convert2proxy(proxy, onRead, onWrite, v)
	if type(v) == "table" then
		v = table.proxytable(v, proxy, onRead, onWrite)
	end
...
function table.isproxy(t)
	return t and type(t) == "table" and rawget(t, "__proxy")
end
...
function table.isimmutable(t)
	return t and type(t) == "table" and rawget(t, "__immutable")
end
